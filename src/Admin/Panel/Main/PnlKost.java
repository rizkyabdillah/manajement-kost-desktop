...
import Admin.Dialog.Master.DialogAddKost;
...
public class PnlKost extends javax.swing.JPanel {

    private final Message msg = new Message();
    private final Koneksi con = new Koneksi();
    private String id = "", nama = "", sql, prefix, postfix = "";
    private ResultSet rs;

    private final String header[] = {
        "Id Kost", "Nama Pemilik Kost", "Nama Kost", "Jenis Kost", "Alamat"
    };
    ...
    public PnlKost(String id) {
        initComponents();
        prefix = "SELECT * FROM VIEW_KOST_RT WHERE id_ketua_rt ='" + id + "' AND (";
        postfix = ")";
        showTabel("");
    }
    ...
    private void showTabel(String key) {
        try {
            ...
            tabel.getColumnModel().getColumn(0).setMinWidth(60);
            ...
            tabel.getColumnModel().getColumn(4).setMinWidth(600);
        } catch (Exception e) {
    ...
    private void onTambah(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_onTambah
        ...
        new DialogAddKost(null, true).setVisible(true);
        showTabel("");
        id = "";
        ...
        try {
            if(id.equals("")) {
                ...
                if(i == JOptionPane.YES_OPTION) {
                    con.setExecute("DELETE FROM KOST WHERE id_kost ='" + id + "'");
                }
            }
            this.id = "";
            showTabel("");
    ...
    private void onPilihTabel(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_onPilihTabel
        try {
            ...
            nama = tabel.getValueAt(tabel.getSelectedRow(), 2).toString();
        } catch (Exception e) {
            id = "";
