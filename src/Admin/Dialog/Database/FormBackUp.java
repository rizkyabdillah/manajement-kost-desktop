...
public class FormBackUp extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images1/a_simpan.png"))); // NOI18N
    ...
    private void onSimpan(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_onSimpan
        try {
            if(path.isEmpty()) {
                msg.msgWarning("Mohon pilih path terlebih dahulu!");
            } else {
                if(os.isUnix()) {
                    command = "/opt/lampp/bin/mysqldump -u root " + con.getDB() + " -r " + path + ".sql";
                } else if(os.isWindows()) {
                    command = "C:\\xampp\\mysql\\bin\\mysqldump -u root " + con.getDB() + " -r " + path + ".sql";
                }
