...
public class PnlLaporanBukuPenghuni extends javax.swing.JPanel {
    ...
    public PnlLaporanBukuPenghuni(String file) {
        initComponents();
        this.file = file;
    }
    ...
    private void initComponents() {
        ...
        boxKategori.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Semua", "Kost" }));
    ...
    private void onReload(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_onReload
        switch(boxKategori.getSelectedIndex()) {
            case 0 :
                ...
                break;
            case 1 :
                query = "id_kost ='" + getID(boxFilter.getSelectedIndex()) + "'";
                break;
        }
