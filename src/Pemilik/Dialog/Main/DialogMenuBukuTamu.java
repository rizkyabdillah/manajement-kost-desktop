...
public class DialogMenuBukuTamu extends javax.swing.JDialog {
    
    public DialogMenuBukuTamu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MENU BUKU TAMU");
        ...
        jLabel7.setText("Daftar Buku Tamu");

        jLabel10.setFont(new java.awt.Font("Lohit Devanagari", 0, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(254, 254, 254));
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/a_menu4_100.png"))); // NOI18N
        ...
        jLabel8.setText("Kelola Buku Tamu");

        jLabel11.setFont(new java.awt.Font("Lohit Devanagari", 0, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(254, 254, 254));
        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/a_menu5_100.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(386, 293));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void onDaftarBuku(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_onDaftarBuku
        this.dispose();
        new FormDaftarBukuTamu().setVisible(true);
    }//GEN-LAST:event_onDaftarBuku

    private void onBukuTamu(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_onBukuTamu
        new DialogBukuTamu(null, true).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogMenuBukuTamu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        
        java.awt.EventQueue.invokeLater(() -> {
            DialogMenuBukuTamu dialog = new DialogMenuBukuTamu(new javax.swing.JFrame(), true);
