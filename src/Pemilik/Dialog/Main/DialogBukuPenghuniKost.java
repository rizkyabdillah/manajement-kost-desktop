...
public class DialogBukuPenghuniKost extends javax.swing.JDialog {
    ...
    private final String header[] = {
        "ID Penghuni", "ID Kost", "Nama Penghuni", "Nama Kost", "Tanggal Masuk", "Tanggal Keluar", "Status"
    };

    public DialogBukuPenghuniKost(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        showTabel("");
    }
    ...
    private void showTabel(String key) {
        try {
            ...
            tabel.getColumnModel().getColumn(0).setMinWidth(140);
            tabel.getColumnModel().getColumn(1).setMinWidth(90);
            tabel.getColumnModel().getColumn(2).setMinWidth(205);
            tabel.getColumnModel().getColumn(3).setMinWidth(205);
            tabel.getColumnModel().getColumn(4).setMinWidth(140);
            tabel.getColumnModel().getColumn(5).setMinWidth(140);
    ...
    private void initComponents() {
        ...
        setTitle("Form Buku Penghuni Kost");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogBukuPenghuniKost.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        
        java.awt.EventQueue.invokeLater(() -> {
            DialogBukuPenghuniKost dialog = new DialogBukuPenghuniKost(new javax.swing.JFrame(), true);
