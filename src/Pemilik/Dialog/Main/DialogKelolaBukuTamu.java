...
public class DialogKelolaBukuTamu extends javax.swing.JDialog {
    ...
    public DialogKelolaBukuTamu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        showTabel("");
    }
    
    public DialogKelolaBukuTamu(java.awt.Frame parent, boolean modal, String ids, boolean status) {
        super(parent, modal);
        initComponents();
        this.id = ids;
        showTabel("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogKelolaBukuTamu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        
        java.awt.EventQueue.invokeLater(() -> {
            DialogKelolaBukuTamu dialog = new DialogKelolaBukuTamu(new javax.swing.JFrame(), true);
