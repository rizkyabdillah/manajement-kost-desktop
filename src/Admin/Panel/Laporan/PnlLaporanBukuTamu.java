...
public class PnlLaporanBukuTamu extends javax.swing.JPanel {
    ...
    public PnlLaporanBukuTamu(String file) {
        initComponents();
        this.file = file;
    }
    ...
    private void setEnabled(int i) {
        boxFilter.setEnabled(false);
        boxTanggal.setEnabled(false);
        switch(i) {
            case 0 :
                boxFilter.setEnabled(true);
                break;
            case 1 :
                boxTanggal.setEnabled(true);
                break;
            default:
                msg.msgWarning("Kesalahan!");
                break;
        }
    }
    ...
    private Date getDate() throws ParseException {
        String dates = new SimpleDateFormat("yyyy-MM-dd")
                .format(boxTanggal.getSelectedDate().getTime());
    ...
    private void initComponents() {
        ...
        boxKategori.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Semua", "Kost", "Penghuni Kost", "Tanggal Kunjungan", "Tanggal Keluar", "Status" }));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(boxFilter, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(boxTanggal, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(boxTanggal, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        try {
            ...
            switch(boxKategori.getSelectedIndex()) {
                case 0 :
                    ...
                    break;
                case 1 :
                    query = "WHERE id_kost ='" + getID(index) + "'";
                    break;
                case 2 :
                    query = "WHERE id_penghuni ='" + getID(index) + "'";
                    break;
                case 3 :
                    query = "WHERE DATE(waktu_kunjung) ='" + getDateSql(getDate()) + "'";
                    break;
                case 4 :
                    query = "WHERE DATE(waktu_pulang) ='" + getDateSql(getDate()) + "'";
                    break;
                case 5 :
                    query = "WHERE status ='" + boxFilter.getSelectedItem() + "'";
                    break;
            }
            ...
            msg.msgError("Error reload : " + e.getMessage());
        }
    ...
    private void onFilter(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_onFilter
        switch(boxKategori.getSelectedIndex()) {
            ...
            case 1 :
                setEnabled(0);
                queryToArray("SELECT id_kost, nama_kost FROM KOST");
                 break;
            case 2 :
                setEnabled(0);
                queryToArray("SELECT id_penghuni, nama_penghuni FROM PENGHUNI_KOST");
                break;
            case 3 :
                setEnabled(1);
                break;
            ...
            case 5 :
                setEnabled(0);
                boxFilter.removeAllItems();
                boxFilter.addItem("Masuk");
                boxFilter.addItem("Keluar");
                break;
        }
