...
public class PnlLaporanNoParam extends javax.swing.JPanel {

    private final Koneksi con = new Koneksi();
    private String file;

    public PnlLaporanNoParam(String file) {
        initComponents();
        this.file = file;
    }
    ...
    private void onReload(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_onReload
        new JasperView().showReportToPanel(file, null, pnlContainer, con.getCon());
