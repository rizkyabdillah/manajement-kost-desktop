...
public class DialogBukuTamu extends javax.swing.JDialog {
    ...
    private void showTabel(String key) {
        try {
            String sql = "SELECT * FROM VIEW_BUKU_TAMU_SATPAM WHERE "
                    + "id_satpam ='" + TempUser.getId() + "' AND ("
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(3, 3, 3)
                        .addComponent(boxCari, javax.swing.GroupLayout.DEFAULT_SIZE, 1118, Short.MAX_VALUE)
                        .addGap(3, 3, 3)
    ...
    private void onLIhatDetail(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_onLIhatDetail
        try {
            if (id.equals("")) {
                ...
                new DialogDetailBukuTamu(null, true, id, false).setVisible(true);
            }
            showTabel("");
        } catch (Exception e) {
