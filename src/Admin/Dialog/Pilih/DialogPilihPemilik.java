...
public class DialogPilihPemilik extends javax.swing.JDialog {
    ...
    private final String header[] = {
        "Id Pemilik", "Nama Pemilik", "No Telp", "Jenis Kelamin", "Alamat"
    };

    public DialogPilihPemilik(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        showTabel("");
    }
    ...
    private void showTabel(String key) {
        try {
            sql = "SELECT * FROM PEMILIK_KOST WHERE "
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" FORM PILIH PEMILIK KOST");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogPilihPemilik.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        
        java.awt.EventQueue.invokeLater(() -> {
            DialogPilihPemilik dialog = new DialogPilihPemilik(new javax.swing.JFrame(), true);
