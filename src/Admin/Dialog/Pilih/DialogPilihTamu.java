...
public class DialogPilihTamu extends javax.swing.JDialog {
    ...
    public DialogPilihTamu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        showTabel("");
    }
    ...
    private void showTabel(String key) {
        try {
            ...
            tabel.getColumnModel().getColumn(2).setMinWidth(540);
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" FORM PILIH TAMU");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogPilihTamu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        
        java.awt.EventQueue.invokeLater(() -> {
            DialogPilihTamu dialog = new DialogPilihTamu(new javax.swing.JFrame(), true);
