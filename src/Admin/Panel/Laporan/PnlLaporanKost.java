...
public class PnlLaporanKost extends javax.swing.JPanel {
    ...
    public PnlLaporanKost(String file) {
        initComponents();
        this.file = file;
    }
    ...
    private void initComponents() {
        ...
        boxKategori.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Semua", "Ketua RT", "Kompleks" }));
    ...
    private void onReload(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_onReload
        switch(boxKategori.getSelectedIndex()) {
            ...
            case 1 :
                ...
                break;
            case 2 :
                query = "WHERE id_kompleks ='" + getID(boxFilter.getSelectedIndex()) + "'";
                break;
        }
    ...
    private void onFilter(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_onFilter
        switch(boxKategori.getSelectedIndex()) {
            ...
            case 1 :
                ...
                break;
            case 2 :
                queryToArray("SELECT id_kompleks, alamat FROM KOMPLEKS");
                break;
        }
