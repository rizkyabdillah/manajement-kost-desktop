...
public class DialogPilihSatpam extends javax.swing.JDialog {
    ...
    private final String header[] = {
        "Id Satpam", "Nama Satpam", "Jenis Kelamin", "No Telp", "Alamat"
    };

    public DialogPilihSatpam(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        showTabel("");
    }
    ...
    private void showTabel(String key) {
        try {
                sql = "SELECT * FROM VIEW_SATPAM WHERE "
                    + "id_satpam LIKE '%" + key + "%' OR "
            ...
            tabel.getColumnModel().getColumn(4).setMinWidth(580);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FORM PILIH SATPAM");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogPilihSatpam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        
        java.awt.EventQueue.invokeLater(() -> {
            DialogPilihSatpam dialog = new DialogPilihSatpam(new javax.swing.JFrame(), true);
