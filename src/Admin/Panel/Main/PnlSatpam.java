...
import Admin.Dialog.Master.DialogAddSatpam;
...
public class PnlSatpam extends javax.swing.JPanel {
    ...
    private final String header[] = {
        "Id Satpam", "Nama Satpam", "Jenis Kelamin", "No Telp", "Alamat", "Username", "Password"  
    };
    ...
    private void onTambah(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_onTambah
        ...
        new DialogAddSatpam(null, true).setVisible(true);
        showTabel("");
        id = "";
        ...
        try {
            if(id.equals("")) {
                ...
                if(i == JOptionPane.YES_OPTION) {
                    ...
                    con.setExecute("DELETE FROM SATPAM WHERE id_satpam ='" + id + "'");
                }
            }
            this.id = "";
            showTabel("");
