...
public class DialogPilihKetuaRT extends javax.swing.JDialog {
    ...
    private final String header[] = {
        "Id Ketua RT", "Nama Ketua RT", "Jenis Kelamin", "No Telp", "Alamat"
    };

    public DialogPilihKetuaRT(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        showTabel("");
    }
    ...
    private void showTabel(String key) {
        try {
            sql = "SELECT * FROM KETUA_RT WHERE "
            ...
            tabel.getColumnModel().getColumn(4).setMinWidth(730);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" FORM PILIH KETUA RT");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogPilihKetuaRT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        
        java.awt.EventQueue.invokeLater(() -> {
            DialogPilihKetuaRT dialog = new DialogPilihKetuaRT(new javax.swing.JFrame(), true);
