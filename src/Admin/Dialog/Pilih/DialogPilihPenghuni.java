...
public class DialogPilihPenghuni extends javax.swing.JDialog {
    
    private final Koneksi con = new Koneksi();
    private final Message msg = new Message();
    private String sql, id = "", ids = "";
    private ResultSet rs;

    private final String header[] = {
        "Id Penghuni", "Nama Penghuni", "Agama", "Tanggal Lahir", "Jenis Kelamin", "No Telp", "Alamat"
    };

    public DialogPilihPenghuni(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        showTabel("", "");
    }
    
    public DialogPilihPenghuni(java.awt.Frame parent, boolean modal, String ids) {
        super(parent, modal);
        initComponents();
        showTabel("", ids);
        this.ids = ids;
    ...
    private void showTabel(String key, String ids) {
        try {
            if(ids.isEmpty()) {
                sql = "SELECT * FROM PENGHUNI_KOST WHERE "
                ...
                sql = "SELECT * FROM VIEW_PENGHUNI_KOST WHERE "
                    + "id_kost ='" + ids + "' AND "
            ...
            tabel.getColumnModel().getColumn(6).setMinWidth(430);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/a_5_120.png"))); // NOI18N
        jLabel2.setText("FORM PILIH PENGHUNI KOST");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogPilihPenghuni.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        
        java.awt.EventQueue.invokeLater(() -> {
            DialogPilihPenghuni dialog = new DialogPilihPenghuni(new javax.swing.JFrame(), true);
